...
class PeppaPigChatbot:
    def __init__(self):
        ...
        # Load Peppa's responses without sound effects
        self.responses = {
            ...
            "family": ["I live with Mummy Pig, Daddy Pig, and my little brother George! He loves his dinosaur!", "My brother George loves his dinosaur!"],
